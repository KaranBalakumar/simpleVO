#ifndef MYVO_G2O_TYPES_H
#define MYVO_G2O_TYPES_H
...
// Unary edge for estimating Pose only
...
class EdgeProjection
   ...
   public:
    ...
    /// Pass Camera intrinsics and extrinsics during construction
